...
def get_video_info(song_name):
    cached_data = cache.get(song_name)
    if cached_data:
        return cached_data
    ...
    if video_id:
        ...
        return {"error": f"No video ID found for '{song_name}'"}
...
def get_video_info_endpoint():
    ...
    video_info = get_video_info(song_name)
